...
def main(args):
    ...
    if args.decay == "polynomial":
        ...
        learning_rate = tf.optimizers.schedules.PolynomialDecay(args.learning_rate, decay_steps, end_learning_rate=args.learning_rate_final)
    elif args.decay == "exponential":
        decay_steps = mnist.train.size / args.batch_size
        decay_rate = args.learning_rate_final / args.learning_rate
        learning_rate = tf.optimizers.schedules.ExponentialDecay(args.learning_rate, decay_steps, decay_rate)
    else:
        learning_rate = args.learning_rate

    if args.optimizer == "SGD":
        optimizer = tf.keras.optimizers.SGD(learning_rate=learning_rate, momentum=(args.momentum if args.momentum else 0))
