...
if __name__ == "__main__":
    ...
    path =  "/home/jam/OneDrive/MFF/LS2021/deep_learning/npfl114/labs/04/logs/last/cifar_competition_dev.txt"
    parser.add_argument("--evaluate", default=path, type=str, help="Prediction file to evaluate")
