...
parser.add_argument("--gamma", default=0.90, type=float, help="Discounting factor.")
    ...
    for _ in range(args.episodes // args.batch_size):
        ...
        for _ in range(args.batch_size):
            ...
            for i, reward in enumerate(rewards):
                return_G.append(args.gamma * np.sum(rewards[i:])) # TODO add the discount factor if needed
